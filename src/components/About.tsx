      ...
      <div ref={aboutRef}>
        ...
        <div className="text-gray-300 ">
          ...
          <p className="text-lg mb-5">
            ...
            complex problems. I enjoy working on all aspects of a project, from
            the design to deployment I make sure everything is how it should be.
            I'm always looking for new ways to incorporate new technologies into
            my projects and hone my existing skills. Right now, I'm learning to
            work with typescript and get better at TDD. If you're interested in
            learning more about my experience and skills or connecting with me,
            please don't hesitate to send me a message. I'm excited to explore
            new opportunities and grow as a software engineer.
          </p>
        </div>
      </div>
    </m.div>
